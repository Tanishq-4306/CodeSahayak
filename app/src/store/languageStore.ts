...
export type LanguageCode = 'en' | 'hi' | 'ta' | 'bn' | 'te' | 'mr' | 'gu' | 'kn' | 'ml';
...
export type TranslationKey = 
  ...
  | 'onboardingTitle' | 'onboardingSubtitle' | 'enableOffline' | 'downloadSize' | 'problemsAvailable' | 'back'
...
const en: Record<TranslationKey, string> = {
  ...
  heroSubtitle: 'CodeSahayak explains programming in 9 Indian languages—so you understand, not just copy.',
  ...
  teachersBullet3: 'Support 9 languages without extra effort',
  ...
  faq1A: 'We support 9 languages: Hindi, Tamil, Bengali, Telugu, Marathi, Gujarati, Kannada, Malayalam, and English.',
  faq2Q: 'Is it free?',
  ...
  faq5A: 'We never give full solutions—only hints and explanations. We\'re also aligned to Indian curricula and work in 9 regional languages.',
...
const hi: Record<TranslationKey, string> = {
  ...
  heroSubtitle: 'CodeSahayak 9 भारतीय भाषाओं में प्रोग्रामिंग समझाता है—ताकि आप केवल कॉपी न करें, बल्कि समझें।',
  ...
  teachersBullet3: 'अतिरिक्त प्रयास के बिना 9 भाषाओं का समर्थन करें',
  ...
  faq1A: 'हम 9 भाषाओं का समर्थन करते हैं: हिंदी, तमिल, बंगाली, तेलुगु, मराठी, गुजराती, कन्नड़, मलयालम और अंग्रेजी।',
  ...
  faq5A: 'हम कभी भी पूर्ण समाधान नहीं देते—केवल संकेत और व्याख्या। हम भारतीय पाठ्यक्रमों के अनुसार भी हैं और 9 क्षेत्रीय भाषाओं में काम करते हैं।',
...
const ta: Record<TranslationKey, string> = {
  ...
  heroSubtitle: 'CodeSahayak 9 இந்திய மொழிகளில் நிரலாக்கத்தை விளக்குகிறது—நீங்கள் நகலெடுக்காமல் புரிந்துகொள்ள உதவுகிறது.',
  ...
  teachersBullet3: 'கூடுதல் முயற்சி இல்லாமல் 9 மொழிகளை ஆதரிக்கவும்',
  ...
  allLanguages: 'அனைத்து 9 மொழிகள்',
  ...
  faq1A: 'நாங்கள் 9 மொழிகளை ஆதரிக்கிறோம்: தமிழ், இந்தி, வங்காளம், தெலுங்கு, மராத்தி, குஜராத்தி, கன்னடம், மலையாளம் மற்றும் ஆங்கிலம்.',
  faq2Q: 'இது இலவசமா?',
  ...
  faq5A: 'நாங்கள் எப்போதும் முழு தீர்வுகளை வழங்குவதில்லை—குறிப்புகள் மற்றும் விளக்கங்கள் மட்டுமே. இந்திய பாடத்திட்டங்களுக்கு ஏற்பவும், 9 பிராந்திய மொழிகளிலும் செயல்படுகிறோம்.',
...
const bn: Record<TranslationKey, string> = { ...en, home: 'হোম', features: 'বৈশিষ্ট্য', forStudents: 'ছাত্রদের জন্য', forTeachers: 'শিক্ষকদের জন্য', dashboard: 'ড্যাশবোর্ড', editor: 'এডিটর', getStarted: 'শুরু করুন', help: 'সাহায্য', heroTitle: 'আপনার মাতৃভাষায় কোডিং শিখুন', heroSubtitle: 'CodeSahayak 9টি ভারতীয় ভাষায় প্রোগ্রামিং ব্যাখ্যা করে।' };
const te: Record<TranslationKey, string> = { ...en, home: 'హోమ్', features: 'ఫీచర్లు', forStudents: 'విద్యార్థుల కోసం', forTeachers: 'ఉపాధ్యాయుల కోసం', dashboard: 'డాష్‌బోర్డ్', editor: 'ఎడిటర్', getStarted: 'ప్రారంభించండి', help: 'సహాయం', heroTitle: 'మీ మాతృభాషలో కోడింగ్ నేర్చుకోండి', heroSubtitle: 'CodeSahayak 9 భారతీయ భాషలలో ప్రోగ్రామింగ్ వివరిస్తుంది.' };
const mr: Record<TranslationKey, string> = { ...en, home: 'होम', features: 'वैशिष्ट्ये', forStudents: 'विद्यार्थ्यांसाठी', forTeachers: 'शिक्षकांसाठी', dashboard: 'डॅशबोर्ड', editor: 'एडिटर', getStarted: 'सुरू करा', help: 'मदत', heroTitle: 'तुमच्या मातृभाषेत कोडिंग शिका', heroSubtitle: 'CodeSahayak 9 भारतीय भाषांमध्ये प्रोग्रामिंग स्पष्ट करते.' };
const gu: Record<TranslationKey, string> = { ...en, home: 'હોમ', features: 'વિશેષતાઓ', forStudents: 'વિદ્યાર્થીઓ માટે', forTeachers: 'શિક્ષકો માટે', dashboard: 'ડેશબોર્ડ', editor: 'એડિટર', getStarted: 'શરૂ કરો', help: 'મદદ', heroTitle: 'તમારી માતૃભાષામાં કોડિંગ શીખો', heroSubtitle: 'CodeSahayak 9 ભારતીય ભાષાઓમાં પ્રોગ્રામિંગ સમજાવે છે.' };
const kn: Record<TranslationKey, string> = { ...en, home: 'ಹೋಮ್', features: 'ವೈಶಿಷ್ಟ್ಯಗಳು', forStudents: 'ವಿದ್ಯಾರ್ಥಿಗಳಿಗೆ', forTeachers: 'ಶಿಕ್ಷಕರಿಗೆ', dashboard: 'ಡ್ಯಾಶ್‌ಬೋರ್ಡ್', editor: 'ಎಡಿಟರ್', getStarted: 'ಪ್ರಾರಂಭಿಸಿ', help: 'ಸಹಾಯ', heroTitle: 'ನಿಮ್ಮ ಮಾತೃಭಾಷೆಯಲ್ಲಿ ಕೋಡಿಂಗ್ ಕಲಿಯಿರಿ', heroSubtitle: 'CodeSahayak 9 ಭಾರತೀಯ ಭಾಷೆಗಳಲ್ಲಿ ಪ್ರೋಗ್ರಾಮಿಂಗ್ ವಿವರಿಸುತ್ತದೆ.' };
const ml: Record<TranslationKey, string> = { ...en, home: 'ഹോം', features: 'ഫീച്ചറുകൾ', forStudents: 'വിദ്യാർത്ഥികൾക്ക്', forTeachers: 'അധ്യാപകർക്ക്', dashboard: 'ഡാഷ്ബോർഡ്', editor: 'എഡിറ്റർ', getStarted: 'ആരംഭിക്കുക', help: 'സഹായം', heroTitle: 'നിങ്ങളുടെ മാതൃഭാഷയിൽ കോഡിംഗ് പഠിക്കുക', heroSubtitle: 'CodeSahayak 9 ഇന്ത്യൻ ഭാഷകളിൽ പ്രോഗ്രാമ്മിംഗ് വിശദീകരിക്കുന്നു.' };
